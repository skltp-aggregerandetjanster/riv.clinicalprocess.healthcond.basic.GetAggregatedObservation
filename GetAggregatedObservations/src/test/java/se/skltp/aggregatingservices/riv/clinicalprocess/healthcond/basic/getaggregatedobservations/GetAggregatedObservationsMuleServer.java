...
public class GetAggregatedObservationsMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedObservations";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedObservationsMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/GetAggregatedObservations-common.xml"
        //
