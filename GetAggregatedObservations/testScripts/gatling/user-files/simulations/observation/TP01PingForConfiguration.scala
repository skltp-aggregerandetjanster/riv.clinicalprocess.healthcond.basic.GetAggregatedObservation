...
import scenarios.GetAggregatedObservationsPingForConfigurationScenario
...
class TP01PingForConfiguration extends Simulation {
  ...
  // dev
  val httpProtocol = http.baseURL("http://ine-dit-app02.sth.basefarm.net:9011/agp/getaggregatedobservations/itintegration/monitoring/PingForConfiguration/1/rivtabp21").disableResponseChunksDiscarding
