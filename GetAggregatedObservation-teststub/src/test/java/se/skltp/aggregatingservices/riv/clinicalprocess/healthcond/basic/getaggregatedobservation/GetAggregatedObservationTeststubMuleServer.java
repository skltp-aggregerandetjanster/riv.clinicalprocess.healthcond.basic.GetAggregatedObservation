...
public class GetAggregatedObservationTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedObservation-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedObservationTeststubMuleServer.class);
