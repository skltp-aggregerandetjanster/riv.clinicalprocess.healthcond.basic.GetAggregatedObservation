...
public class GetAggregatedObservationsTeststubMuleServer {

    public static final String MULE_SERVER_ID = "GetAggregatedObservations-teststub";

    private static final Logger logger = LoggerFactory.getLogger(GetAggregatedObservationsTeststubMuleServer.class);
