...
public class GetAggregatedObservationMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedObservation";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedObservationMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/GetAggregatedObservation-common.xml"
        //
