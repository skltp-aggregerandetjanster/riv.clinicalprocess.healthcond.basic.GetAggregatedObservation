...
class TP00WarmUp extends Simulation {
  ...
  val baseURL          = if (System.getProperty("baseUrl") != null && !System.getProperty("baseUrl").isEmpty()) System.getProperty("baseUrl") else "http://33.33.33.33:8081/GetAggregatedObservations/service/v1"
